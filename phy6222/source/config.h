...
#define DEVICE_WATCH_1 99

#ifndef DEVICE
#define DEVICE DEVICE_WATCH_1
#endif
...
#else
#define DEV_SERVICES (OTA_TYPE | SERVICE_THS | SERVICE_KEY | SERVICE_HISTORY | SERVICE_TH_TRG | SERVICE_RDS | SERVICE_BINDKEY)
#endif
...
/* Model: TH05 v1.3*/
#if OTA_TYPE == OTA_TYPE_BOOT
#define DEV_SERVICES (OTA_TYPE | SERVICE_SCREEN | SERVICE_THS | SERVICE_KEY)
#else
#define DEV_SERVICES (OTA_TYPE | SERVICE_SCREEN | SERVICE_THS | SERVICE_KEY | SERVICE_HISTORY | SERVICE_TH_TRG | SERVICE_RDS | SERVICE_BINDKEY)
#endif
...
#define DEF_MODEL_NUMBER_STR "WATC"
#define DEF_HARDWARE_REVISION "9999"
#define DEF_MANUFACTURE_NAME_STR "China"
...
inline uint32 clock_time_rtc(void)
{
	...
	while (tick != *(volatile uint32_t *)0x4000f028;) // AP_AON->RTCCNT
		return tick;
} // (*(volatile unsigned int*)0x4000f028); }// & 0xffffff; // max 512 sec
#endif
